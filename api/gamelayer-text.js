export default function handler(req, res) {
  ...
  const gamelayerText = `GameLayer - Gamification Platform & API
...
Use Cases:
- E-commerce & Retail - Loyalty programs, referral systems, seasonal challenges
...
- Mobile Apps - User engagement, retention, social features
...
Keywords:
gamification platform, gamification software, gamification SaaS, gamification API, enterprise gamification solution, gamification for business, gamification platform pricing, gamification service provider, gamification tools, gamification system, gamification for e-learning, gamification for training, gamification for employee engagement, gamification for customer loyalty, gamification for sales teams, gamification for retail, gamification for finance apps, gamification for healthcare, gamification for fitness apps, gamification for HR, gamification API integration, gamified rewards system, loyalty points gamification, badges and leaderboard software, achievement tracking platform, experience points system software, game mechanics for apps, behavioral nudges gamification, incentive platform`;

  res.setHeader('Content-Type', 'text/plain; charset=utf-8');
  res.send(gamelayerText);
}
