...
import { X, Users2, Upload } from 'lucide-react';

const AddTeamModal = ({ open, onClose, onSave }) => {
          ...
          <div className="flex items-center justify-between p-6 border-b border-gray-200">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Create a new team for your gamification system</p>
              </div>
            </div>
            <button
              onClick={onClose}
