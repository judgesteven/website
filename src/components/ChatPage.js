...
const ChatPage = () => {
  ...
  return (
    <>
      <SEOHead
        title="AI Chat - GameLayer"
        description="Chat with our AI assistant to learn about gamification, get implementation help, and discover how GameLayer can transform your user engagement."
        keywords="AI chat, gamification help, user engagement, loyalty programs, gamification implementation, AI assistant"
      />
